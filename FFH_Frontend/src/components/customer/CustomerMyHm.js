...
const CustomerMyHm = (props) => {
  ...
  useEffect(() => {
    ...
    CustomerService.getMyHomeMaker(SessionService.getCurrentUser().id).then((response) => {
      ...
      SessionService.storeHomeMaker(response.data)
    })
  }, [])
                ...
                <CardDeck>
                  <Card>
                    ...
                    <CardBody>
                      ...
                      <Button className="btn-info" onClick={() => buttonHandle("MINI", 200)}>&#8377;200</Button>
                    </CardBody>
                  </Card>
                  <Card>
                    ...
                    <CardBody>
                      ...
                      <Button className="btn-info" onClick={() => buttonHandle("CLASSIC", 380)}>&#8377;380</Button>
                    </CardBody>
                  </Card>
                  <Card>
                    ...
                    <CardBody>
                      ...
                      <Button className="btn-info" onClick={() => buttonHandle("JUMBO", 750)}>&#8377;750</Button>
                    </CardBody>
                  </Card>
                </CardDeck>
              </div>
