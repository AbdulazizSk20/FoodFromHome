    ...
    const handleForm = (e) => {
        ...
        service.addUser(user)
            .then((response) => {
                ...
                swal("Registration Successfull!!!",`User Id: ${response.data.id}`,"success")
                ...
                swal("Registration Failed!!!","Mail id already in use","error")
            }
            )
    }
                    ...
                    <Fragment>
                        <Form onSubmit={handleForm}>
                            ...
                            <div className="form-row">
                                <FormGroup className="form-col col-md-4 ">
                                    <Input
                                        type="email"
