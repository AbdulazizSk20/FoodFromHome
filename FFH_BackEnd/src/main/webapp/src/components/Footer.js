        ...
        <div className="main-footer my-1">
            <div className="container">
                ...
                <div className="row" align="center">
                    <p className="col-sm">
                        Copyright&copy; {new Date().getFullYear()} FOOD FROM HOME&trade; | FFH&reg; is a registered trademark of the Food from Home, Inc. | All Rights Reserved | Terms of Service | Privacy Policy
        </p>
